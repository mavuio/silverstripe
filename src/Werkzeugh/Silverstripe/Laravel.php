...
namespace Werkzeugh\Silverstripe;
...
class Laravel {
    public static function configureSilverstripe() {
        ...
        $databaseConfig = array(
            "type" => $config['driver'] == 'mysql' ? '\Werkzeugh\Silverstripe\MySQLDatabaseWrapper' : "Don't know how to translate Laravel database driver {$config['driver']} to Silverstripe database type",
            "server" => $config['host'],
